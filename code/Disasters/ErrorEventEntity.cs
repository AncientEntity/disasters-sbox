...
namespace Disasters
{
	public class ErrorEventEntity : EventEntity
	{
		...
		public void SpawnError()
		{
			...
			erEnt.Position = new Vector3( DisastersGame.random.Next( -1227, 1601 ), DisastersGame.random.Next( -1691, 1159 ), DisastersGame.random.Next( -100, 720 ) );
			erEnt.Rotation = Rotation.FromAxis(new Vector3( DisastersGame.random.Next( 0, 360 ) , DisastersGame.random.Next( 0, 360 ) , DisastersGame.random.Next( 0, 360 )), (float)DisastersGame.random.NextDouble());
		...
		public class ErrorEntity : ModelEntity
		{
			public ErrorEntity()
			{
				DisastersGame.RegisterEventEntity( this );
			}
